var app = angular.module('myApp', ['appController', 'appDirectives','appService','ngRoute', 'LocalStorageModule','LocalStorageModule','ui.bootstrap','pascalprecht.translate','ngStorage']);
